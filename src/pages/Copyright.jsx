        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 space-y-8">
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              © {new Date().getFullYear()} openTILL Corporation. All rights reserved.
            </p>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              are the exclusive property of openTILL Corporation or its content suppliers and are protected by 
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              property of openTILL Corporation or their respective owners. Unauthorized use of any of these 
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              translation, or any other use is prohibited without the prior written permission of openTILL Corporation.
            </p>
          </div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              For inquiries regarding copyright or intellectual property matters, please contact openTILL Corporation.
            </p>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
            <p className="text-sm text-blue-900 dark:text-blue-100">
              ...
              of any kind. openTILL Corporation makes no warranties, express or implied, regarding the accuracy, 
