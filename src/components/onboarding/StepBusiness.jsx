  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="text-center space-y-1 mb-2">
        <h2 className="text-2xl font-black text-slate-900">{t('onboarding.businessDetails')}</h2>
        <p className="text-slate-500 text-sm">{t('onboarding.businessDetailsSub')}</p>
      </div>

      {field('business_name', t('onboarding.businessName'), <Building2 className="w-4 h-4" />, {
        required: true,
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-1.5">
          <Label htmlFor="first_name" className="text-slate-700 font-medium">{t('onboarding.firstName')}</Label>
          <div className="relative">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="last_name" className="text-slate-700 font-medium">{t('onboarding.lastName')}</Label>
      ...
      {field('email', t('onboarding.emailAddress'), <Mail className="w-4 h-4" />, {
        required: true,
        type: 'email',
      ...
      {field('phone', t('onboarding.phoneOptional'), <Phone className="w-4 h-4" />, {
        type: 'tel',
      ...
      {field('address', t('onboarding.businessAddressOptional'), <MapPin className="w-4 h-4" />, {
