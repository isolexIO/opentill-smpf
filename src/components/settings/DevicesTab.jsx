...
const DEVICE_CATEGORIES = [
  {
    ...
    bg: 'bg-blue-50',
    types: [
      { value: 'verifone_p400', label: 'Verifone P400 (Ethernet)' },
      { value: 'bbpos_wisepad3s', label: 'BBPOS WisePad 3 (LAN)' },
      { value: 'bbpos_wisepad3', label: 'BBPOS WisePad 3 (Bluetooth)' },
      { value: 'bbpos_b250m', label: 'BBPOS B250M (Bluetooth)' },
      { value: 'stripe_m2', label: 'Stripe Reader M2 (Bluetooth)' },
    ],
    connections: ['bluetooth', 'ethernet', 'wifi'],
    defaultPort: 8080,
    description: 'Stripe Terminal card readers for tap, dip, and swipe payments',
  },
  {
    key: 'printers',
    label: 'Printers',
